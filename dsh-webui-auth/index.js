...
<style>
  ...
  /* 天枢平台: brand blue + the two-column sign-in stage. */
  body { --tianshu-primary: #2563EB; --tianshu-primary-hover: #1D4ED8;
    --tianshu-tint-strong: #DCE7FB; --tianshu-tint-soft: #F1F6FE; }
  body[data-ds-dark-theme] { --tianshu-primary: #4F86F7; --tianshu-primary-hover: #6C9BFA;
    --tianshu-tint-strong: #16233D; --tianshu-tint-soft: #101A2E; }
  body { margin: 0; min-height: 100vh; display: grid;
    grid-template-columns: minmax(360px, 480px) minmax(0, 1fr);
    align-items: center; gap: 48px; padding: 0 clamp(24px, 6vw, 120px); box-sizing: border-box;
    background:
      radial-gradient(110% 80% at 76% 34%, var(--tianshu-tint-strong) 0%, transparent 62%),
      linear-gradient(135deg, var(--dsw-alias-bg-base, #fff) 0%, var(--tianshu-tint-soft) 100%);
    font-family: system-ui, -apple-system, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', sans-serif; }
  .card { width: 100%; max-width: 480px; padding: 40px 40px 44px; box-sizing: border-box;
    background: var(--dsw-alias-bg-layer-1, #fff); border: 1px solid var(--dsw-alias-border-l1, #ddd);
    border-radius: 12px; box-shadow: 0 16px 48px rgba(37, 99, 235, .12); }
  h1 { margin: 0 0 6px; font-size: 28px; font-weight: 600; color: var(--dsw-alias-label-primary, #222); }
  /* Key art: decorative, and the first thing to go when width runs out. */
  .art { display: flex; flex-direction: column; align-items: center; justify-content: center;
    min-width: 0; color: var(--tianshu-primary); }
  .art-title { margin-bottom: 8px; font-size: 30px; font-weight: 700; letter-spacing: .04em; }
  @media (max-width: 900px) {
    body { grid-template-columns: minmax(0, 1fr); justify-items: center; }
    .art { display: none; }
  }
  ...
  input { box-sizing: border-box; width: 100%; padding: 11px 13px; font-size: 14px; color: var(--dsw-alias-label-primary, #222);
    background: var(--dsw-alias-bg-layer-2, #fff); border: 1px solid var(--dsw-alias-border-l2, #ccc); border-radius: 6px; outline: none; }
  ...
  button { width: 100%; margin-top: 22px; padding: 12px 18px; font-size: 15px; font-weight: 500;
    cursor: pointer; color: #fff; background: var(--tianshu-primary);
    border: none; border-radius: 6px; }
  button:hover:not(:disabled) { background: var(--tianshu-primary-hover); }
...
<div class="art">
  <div class="art-title">天枢平台</div>
  <svg viewBox="0 0 520 420" fill="none" width="100%" aria-hidden="true">
    <defs>
      <linearGradient id="ts-shield" x1="260" y1="40" x2="260" y2="300">
        <stop offset="0%" stop-color="currentColor" stop-opacity=".28"/>
        <stop offset="100%" stop-color="currentColor" stop-opacity=".06"/>
      </linearGradient>
      <linearGradient id="ts-wave" x1="0" y1="300" x2="520" y2="420">
    ...
    <ellipse cx="260" cy="188" rx="176" ry="58" stroke="currentColor" stroke-opacity=".18" stroke-width="1.5"/>
    <ellipse cx="260" cy="188" rx="176" ry="58" stroke="currentColor" stroke-opacity=".12" stroke-width="1.5" transform="rotate(-24 260 188)"/>
    <path d="M260 52 366 92v104c0 58-44 96-106 118-62-22-106-60-106-118V92z" fill="url(#ts-shield)" stroke="currentColor" stroke-opacity=".5" stroke-width="2"/>
    <path d="M260 84 334 112v82c0 42-32 70-74 86-42-16-74-44-74-86v-82z" stroke="currentColor" stroke-opacity=".32" stroke-width="1.4"/>
    <path d="M260 132l13.5 27.6 30.5 4.4-22 21.5 5.2 30.4L260 201.9l-27.2 14.4 5.2-30.4-22-21.5 30.5-4.4z" fill="currentColor" fill-opacity=".5"/>
    <ellipse cx="260" cy="322" rx="132" ry="34" fill="currentColor" fill-opacity=".1"/>
    <ellipse cx="260" cy="316" rx="132" ry="34" stroke="currentColor" stroke-opacity=".3" stroke-width="1.6"/>
    <ellipse cx="260" cy="312" rx="96" ry="24" stroke="currentColor" stroke-opacity=".22" stroke-width="1.3"/>
    <path d="M0 392c72-34 132-34 200-6s136 30 200-14 84-36 120-24v72H0z" fill="url(#ts-wave)"/>
    <path d="M0 374c76-32 138-30 204-4s134 28 196-16" stroke="currentColor" stroke-opacity=".28" stroke-width="1.4"/>
  </svg>
</div>
<script>
var MODE = "__MODE__";
