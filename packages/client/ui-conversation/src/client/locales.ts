...
export const zh = {
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.queryRail': 'Query 导航',
  'chat.queryIndex': 'Query {index}',
  'chat.queryLabel': 'Query {index}：{preview}',
  'chat.queryImageOnly': '图片 Query',
  'chat.queryNoText': '无文本 Query',
...
export const en = {
  ...
  'chat.queryRail': 'Query navigation',
  'chat.queryIndex': 'Query {index}',
  'chat.queryLabel': 'Query {index}: {preview}',
  'chat.queryImageOnly': 'Image query',
  'chat.queryNoText': 'Query without text',
