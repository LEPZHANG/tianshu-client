...
/**
 * Split a user message's content into its renderable parts.
 * @param content - the message's content blocks, as logged.
 * @returns the concatenated text, the image attachments, and any block neither of those.
 */
