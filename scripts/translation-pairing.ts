...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  '**/node_modules/**',
  // Independent git checkouts that live inside this repository (the desktop
  // shell and the WebUI auth plugin). Their documentation follows their own
  // upstream conventions and is not part of this corpus.
  'dsh-desktop/**',
  'dsh-webui-auth/**',
  '**/lib/**',
  '**/.pnpm-store/**',
